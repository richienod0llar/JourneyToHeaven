...
public class StarSpawnerController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            // transform.position
            // multiplication with 3 because the maximum deltaYPositionRatio of a star is 1
            ...
            // spawn
            GameObject star = Instantiate(starPrefab, position, rotation, camera.transform) as GameObject;
        }
